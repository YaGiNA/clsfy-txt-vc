...
def get_rawnet2_outputs():
    ...
    return normalized_vals, y_ordered

if __name__ == '__main__':
    labels, outputs = get_rawnet2_outputs()
    y_target = np.array(labels)
    fpr, tpr, thresholds = metrics.roc_curve(y_target, outputs, pos_label=1)
    fnr = 1 - tpr
